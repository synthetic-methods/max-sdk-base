...
enum t_jit_gl_layer {
	...
	JIT_GL_LAYER_DEFAULT	= 0,
	JIT_GL_LAYER_LAST		= 1000
};

// animator update priority flags
enum t_jit_gl_animator_priority {
	JIT_ANIMATOR_PRIORITY_FIRST	= -1000,
	JIT_ANIMATOR_PRIORITY_DEF	= 0,
	JIT_ANIMATOR_PRIORITY_PASS2	= 1000,	// updated *after* nodes are updated
};

// default animator mouse-ui priority
enum t_jit_anim_ui_priority {
	JIT_ANIM_UIP_FIRST			= -1000,
	JIT_ANIM_UIP_CORNERPIN		= -900,	// gl.cornerpin
	JIT_ANIM_UIP_PHYS			= -800,	// phys.picker
	JIT_ANIM_UIP_HANDLE			= -700,	// gl.handle
	JIT_ANIM_UIP_DEFAULT		= 0,
	JIT_ANIM_UIP_ADRIVE			= 900,	// anim.drive
	JIT_ANIM_UIP_LAST			= 1000
};

enum {
	JIT_GL_MAX_PICK_FILTERS		= 10
};
...
enum t_jit_ob3d_flags {
	JIT_OB3D_NO_ROTATION_SCALE			= 1 << 0,      ///< ob3d flag @ingroup jitter
	JIT_OB3D_NO_POLY_VARS				= 1 << 1,      ///< ob3d flag @ingroup jitter
	JIT_OB3D_NO_BLEND					= 1 << 2,      ///< ob3d flag @ingroup jitter
	JIT_OB3D_NO_TEXTURE					= 1 << 3,      ///< ob3d flag @ingroup jitter
	JIT_OB3D_NO_MATRIXOUTPUT			= 1 << 4,      ///< ob3d flag @ingroup jitter
	JIT_OB3D_AUTO_ONLY					= 1 << 5,      ///< ob3d flag @ingroup jitter
	JIT_OB3D_DOES_UI					= 1 << 6,      ///< ob3d flag @ingroup jitter
	JIT_OB3D_NO_DEPTH					= 1 << 7,      ///< ob3d flag @ingroup jitter
	JIT_OB3D_NO_ANTIALIAS				= 1 << 8,      ///< ob3d flag @ingroup jitter
	JIT_OB3D_NO_FOG						= 1 << 9,      ///< ob3d flag @ingroup jitter
	JIT_OB3D_NO_LIGHTING_MATERIAL		= 1 << 10,     ///< ob3d flag @ingroup jitter
	JIT_OB3D_HAS_LIGHTS					= 1 << 11,     ///< ob3d flag @ingroup jitter
	JIT_OB3D_HAS_CAMERA					= 1 << 12,     ///< ob3d flag @ingroup jitter
	JIT_OB3D_IS_RENDERER				= 1 << 13,     ///< ob3d flag @ingroup jitter
	JIT_OB3D_NO_COLOR					= 1 << 14,     ///< ob3d flag @ingroup jitter
	JIT_OB3D_IS_SLAB					= 1 << 15,     ///< ob3d flag @ingroup jitter
	JIT_OB3D_NO_SHADER					= 1 << 16,
	JIT_OB3D_IS_NODE					= 1 << 17,
	JIT_OB3D_IS_CAMERA					= 1 << 18,
	JIT_OB3D_NO_BOUNDS					= 1 << 19,
	JIT_OB3D_NO_POSITION				= 1 << 20
};

typedef long t_jit_gl_context_modifier;

enum t_jit_gl_view_key {
	JIT_GL_VIEW_COMMAND_KEY		= (1<<0),
	JIT_GL_VIEW_SHIFT_KEY		= (1<<1),
	JIT_GL_VIEW_CAPS_LOCK		= (1<<2),
	JIT_GL_VIEW_ALT_KEY			= (1<<3),
	JIT_GL_VIEW_CONTROL_KEY		= (1<<4)
};
